...
if __name__ == '__main__':
    ...
    print("Loading Google News word vectors. This might take a while...")
    model = word2vec.KeyedVectors.load_word2vec_format('./GoogleNews-vectors-negative300.bin.gz', binary=True, limit=500000)
    model.init_sims(replace=True)
    print("Loading FastText word vectors. This might take a while...")
    model2 = FastText.load_fasttext_format('./wiki.simple/wiki.simple.bin')


    print("Starting internal browser. This might take a while and even fail!...")
    options = Options()
